...
$string['presentation'] = 'Présentation de mon espace de formation';
...
$string['nonloggedcontact'] = 'Contact (utilisateur non connecté)';
$string['nonloggedcontact_desc'] = 'Lien vers la page de contact';
$string['faq'] = 'Aide';
...
$string['mentorlicencedefault']
    = 'Sauf mention contraire, tous les contenus de ce site sont sous <a href= "https://www.etalab.gouv.fr/" target="_blank"> licence etalab - 2.0</a >';
...
$string['footerlogofrancerelancetitle'] = 'France Relance';
$string['footerlogofinanceuetitle'] = 'Financement Union Européenne';
$string['accessibility'] = 'Accessibilité : partiellement conforme';
...
$string['rizomobodytag'] = 'Balise Rizomo';
$string['rizomobodytag_desc'] = 'Balise Rizomo sur le body';
...
$string['verifywarningsinfo']
    = 'Attention : Votre profil Mentor vous suit tout au long de votre carrière. Si vous aviez déjà un compte Mentor avec une autre adresse mél, vous n\'avez pas besoin de créer un nouveau compte. Vous avez la possibilité de modifier votre adresse mél de manière autonome en éditant votre profil Mentor : <a href="{$a}">{$a}</a> (ce lien nécessite de vous reconnecter avec votre adresse mél précédente).';

$string['agentconnectname'] = 'Agent Connect';
$string['agentconnectbuttontext'] = 'S’identifier avec <span>AgentConnect</span>';
